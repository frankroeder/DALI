...
from carl.envs.dmc import CARLDmcBallInCupEnv, CARLDmcWalkerEnv
...
BALLINCUP_TRAIN_GRAVITY_RANGE = [4.9, 14.70]
BALLINCUP_TRAIN_DISTANCE_RANGE = [0.15, 0.45]
...
_TASK2CONTEXTS = {
    ...
    "dmc_ball_in_cup": [
        {
            "context": "gravity",
            "train_range": BALLINCUP_TRAIN_GRAVITY_RANGE,
        ...
        {
            "context": "distance",
            "train_range": BALLINCUP_TRAIN_DISTANCE_RANGE,
            "interpolate_single": [0.15, 0.225, 0.3, 0.375, 0.45],
            "interpolate_double": [0.15, 0.3, 0.45],
            "extrapolate_single": [0.03, 0.06, 0.09, 0.12, 0.48, 0.51, 0.54, 0.57, 0.6],
            "extrapolate_double": [0.03, 0.09, 0.48, 0.54, 0.6],
        },
    ],
    "dmc_walker": [
        {
...
_TASK2ENV = {
    ...
    "dmc_ball_in_cup": CARLDmcBallInCupEnv,
...
class NormalizeContextWrapper(Wrapper):
    _CLASS_TO_CTX_NORMALIZER = {
        ...
        CARLDmcBallInCupEnv: {
            "gravity": BALLINCUP_TRAIN_GRAVITY_RANGE,
            "distance": BALLINCUP_TRAIN_DISTANCE_RANGE,
        },
        CARLDmcWalkerEnv: {
